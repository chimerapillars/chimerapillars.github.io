		...
		<>
			...
			<Box sx={sx.textContainer}>
				<Typography variant='text'>
					...
					<a href={galeryurl} style={{ textDecoration: 'none', color: colors.primary, fontWeight: '700' }} target='_blank' rel='noopener noreferrer'> Beinart Gallery </a>
					{'owner '}
					<a href={jurl} style={{ textDecoration: 'none', color: colors.primary, fontWeight: '700' }} target='_blank' rel='noopener noreferrer'> Jon Beinart </a>
					{'and his friend of 15 years, the award-winning graphic novelist and artist, '}
					<a href={turl} style={{ textDecoration: 'none', color: colors.primary, fontWeight: '700' }} target='_blank' rel='noopener noreferrer'> Tim Molloy</a>
